...
import lk.ac.vau.fas.ict.repo.BookRepo;
import lk.ac.vau.fas.ict.repo.BorrowRepo;
import lk.ac.vau.fas.ict.repo.StudentRepo;

@Service
public class BorrowService {
    @Autowired
    public BorrowRepo borrowRepository;
